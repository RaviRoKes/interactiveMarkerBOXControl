...
namespace interactive_marker_tutorials
{
  ...
  public:
    ...
    void createBoxMarker(const tf2::Vector3 &position);
  ...
  private:
    ...
    void frameCallback();                                                                                     // This method periodically broadcasts transform data for moving and rotating frame
